...
export default function Component() {
  return (
    <div className="flex flex-col h-screen bg-[#1b365d] dark:bg-gray-900">
      <header className="flex items-center justify-between h-12 px-4 border-b border-gray-100 border-gray-800 dark:border-gray-850">
        <span className="text-lg font-normal text-white dark:text-gray-300">yt-helper</span>
